(function(){
  ...
  function lifecycleMixin (Vue) {
    ...
    Vue.prototype._update = function (vnode) {
      ...
      vm._vnode = vnode
      // 若不存在prevVnode,说明是初次渲染
      vm.$el = this.__patch__(prevVnode, vnode, vm.$options)
    }
  }
  function renderMixin (Vue) {
    ...
    // 挂载、更新vnode到页面上
    Vue.prototype.__patch__ = function (oldVnode, vnode, parentElm) {
      console.log('patch vnode to page')
    }
